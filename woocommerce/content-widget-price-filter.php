...
$hasPrice = ($nasa_min !== '' && $nasa_max !== '' && ($nasa_min >= 0 || $nasa_max >= $nasa_min)) ? '1' : '0';
$class_reset = $hasPrice == '1' ? 'reset_price' : 'reset_price hidden-tag';
    ...
    <div class="price_slider_wrapper">
        ...
        <div class="price_slider_amount" data-step="<?php echo esc_attr($step); ?>">
            ...
            <div class="price_label" style="display:none;">
                ...
                <a href="javascript:void(0);" class="<?php echo esc_attr($class_reset); ?>" data-filtered="<?php echo $hasPrice ? '1' : '0'; ?>" rel="nofollow"><?php echo esc_html__('Reset', 'elessi-theme'); ?></a>
            </div>
            <?php echo wc_query_string_form_fields(null, array('min_price', 'max_price', 'paged'), '', true); ?>
            <?php /* input type="hidden" class="nasa_hasPrice" name="nasa_hasPrice" value="<?php echo esc_attr($hasPrice); ?>" / */?>
            <div class="clear"></div>
        </div>
    </div>
</form>
