...
defined('NASA_VERSION') or define('NASA_VERSION', '4.8.8');
...
define('ELESSI_THEME_URI', get_stylesheet_directory_uri());
...
// WP Head and other cleanup functionsrequire_once(get_template_directory().'/functions/cleanup.php'); 
/**
 * Options theme
 */
