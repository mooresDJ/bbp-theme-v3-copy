...
if (!function_exists('elessi_get_header_structure')):
    function elessi_get_header_structure() {
         ...
         * Transparent header
         */
        $header_transparent = isset($nasa_opt['header_transparent']) && $nasa_opt['header_transparent'] ? true : false;
        ...
        switch ($show_icon_cat_top) :
            ...
            case 'show-in-shop':
            default:
                $show_cat_top_filter = NASA_WOO_ACTIVED && is_product_taxonomy() ? true : false;
                break;
        endswitch;
