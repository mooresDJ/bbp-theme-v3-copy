...
if (!function_exists('elessi_mini_cart')) {
    function elessi_mini_cart($recount = false) {
        ...
        if (!$nasa_mini_cart) {
            ...
            $nasa_mini_cart = 
            '<a href="javascript:void(0);" class="cart-link mini-cart cart-inner inline-block" title="' . esc_attr__('Cart', 'elessi-theme') . '" rel="nofollow">' .
...
if (!function_exists('elessi_before_account_nav')) :
    function elessi_before_account_nav() {
        ...
        <div class="account-nav-wrap vertical-tabs">
            <div class="bbpAccountUser account-nav account-user hide-for-small">
...
if (!function_exists('elessi_account_dashboard_nav')) :
    function elessi_account_dashboard_nav() {
        ...
        ?>
        <nav class="bbpNavSquare woocommerce-MyAccount-navigation nasa-MyAccount-navigation">
            <ul>
...
function elessi_sku_search_where($where){
    ...
    $where = preg_replace(
        ...
        "({$wpdb->posts}.post_title LIKE $1) OR (nspm.meta_value LIKE $1)", $where);
