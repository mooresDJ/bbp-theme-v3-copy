...
if (!function_exists('elessi_header_footer_heading')) {
    function elessi_header_footer_heading() {
        ...
        $of_options[] = array(
            ...
            'class' => 'hidden-tag nasa-header-type-child nasa-header-type-select-1 nasa-header-type-select-2 nasa-header-type-select-3 nasa-header-type-select-4 nasa-header-type-select-6 nasa-header-block'
        );
        ...
        $of_options[] = array(
            ...
            "type" => "select",
            "options" => $static_blocks,
            'class' => 'hidden-tag nasa-header-type-child nasa-header-type-select-4 nasa-header-type-select-6 nasa-header-block-type_4'
        );
