...
function nasa_wpb_christmas() {
    return array(
        'post' => array(
            ...
            'post_content' => '[vc_row fullwidth="1" el_class="margin-bottom-20 mobile-margin-bottom-5"][vc_column][nasa_rev_slider alias="Slider-Christmas"][/vc_column][/vc_row][vc_row el_class="margin-bottom-30 mobile-margin-bottom-40"][vc_column width="1/3"][nasa_banner_2 align="right" effect_text="fadeInLeft" hover="zoom" height="212" img_src="3318"]
...
[/nasa_banner_2][/vc_column][vc_column width="1/3"][nasa_banner_2 align="right" effect_text="fadeInLeft" hover="zoom" height="212" img_src="3318"]
<h4 class="fs-27 mobile-fs-25" style="line-height: 1.4; margin-top: 30px;">Ornaments
Ball</h4>
<h5 class="fs-17 mobile-fs-15" style="text-decoration: underline;"><a style="color: #000000;" title="Shop now" href="#">Shop now</a></h5>
[/nasa_banner_2][/vc_column][vc_column width="1/3"][nasa_banner_2 move_x="45%" effect_text="fadeInLeft" hover="zoom" height="212" img_src="3318"]
