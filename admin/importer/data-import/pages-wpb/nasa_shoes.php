...
function nasa_wpb_shoes() {
    return array(
        'post' => array(
            ...
            'post_name' => 'wpb-shoes',
            'post_content' => '[vc_row fullwidth="1" css=".vc_custom_1528394118934{margin-top: 50px !important;margin-bottom: 50px !important;}" el_class="padding-bottom-40"][vc_column][nasa_products style="slide_slick" shop_url="0" arrows="0" auto_slide="true" number="4" columns_number="1"][/vc_column][/vc_row][vc_row el_class="margin-top-40"][vc_column width="1/3"][nasa_banner valign="bottom" effect_text="fadeInLeft" hover="zoom" data_delay="500ms" img_src="3139"]
    <h5 style="font-weight: bold;">New
    season 2018</h5>
    <h6 style="color: #999; font-size: 120%;">Shoes &amp; Accessories</h6>
    [/nasa_banner][/vc_column][vc_column width="1/3"][nasa_banner effect_text="fadeInLeft" hover="zoom" data_delay="500ms" img_src="3139"]
    <h5 style="font-weight: bold;">Classic Colections</h5>
    <h6 style="color: #999; font-size: 120%;">Sale off 50%</h6>
    [/nasa_banner][/vc_column][vc_column width="1/3"][nasa_banner valign="middle" effect_text="fadeInLeft" hover="zoom" data_delay="500ms" img_src="3139"]
