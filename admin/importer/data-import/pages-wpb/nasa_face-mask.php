...
function nasa_wpb_face_mask() {
    ...
    <a class="margin-top-30" style="text-decoration: underline; color: #fff; display: block; font-size: 90%;" href="#">Shop Now</a>[/nasa_banner][/vc_column][vc_column width="1/3"][nasa_banner img_src="3136"]
    <h5 style="font-size: 180%;">Face mask
    with cute pattern</h5>
    <a class="margin-top-10" style="text-decoration: underline; color: #323232; display: block;" href="#">Shop Now</a>[/nasa_banner][/vc_column][vc_column width="1/3"][nasa_banner img_src="3136"]
    <h5 style="font-size: 180%;">Cloth
    Face mask</h5>
    <a class="margin-top-10" style="text-decoration: underline; color: #323232; display: block;" href="#">Shop Now</a>[/nasa_banner][/vc_column][/vc_row][vc_row el_class="margin-bottom-30"][vc_column width="1/3" el_class="mobile-margin-top-20"][nasa_title title_text="Top Rated" title_type="h3" font_size="m" el_class="margin-bottom-30"][nasa_products style="list_carousel" style_row="3" arrows="1" number="6" columns_number="1" columns_number_small="1" columns_number_tablet="1"][/vc_column][vc_column width="1/3" el_class="mobile-margin-top-20"][nasa_title title_text="Best Selling" title_type="h3" font_size="m" el_class="margin-bottom-30"][nasa_products style="list_carousel" style_row="3" arrows="1" number="6" columns_number="1" columns_number_small="1" columns_number_tablet="1"][/vc_column][vc_column width="1/3" el_class="mobile-margin-top-20"][nasa_title title_text="On Sale" title_type="h3" font_size="m" el_class="margin-bottom-30"][nasa_products style="list_carousel" style_row="3" arrows="1" number="6" columns_number="1" columns_number_small="1" columns_number_tablet="1"][/vc_column][/vc_row][vc_row el_class="margin-bottom-30"][vc_column][nasa_title title_text="Latest blog" title_type="h3" font_size="xl" title_desc="The freshest and most exciting news" title_align="text-center" el_class="margin-bottom-30"][nasa_post dots="true" arrows="0" posts="4" columns_number="3" columns_number_small="1" columns_number_tablet="3" date_enable="no" author_enable="no" page_blogs="no"][/vc_column][/vc_row]'
        ),
        'post_meta' => array(
