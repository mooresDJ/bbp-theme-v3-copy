<?php
function nasa_wpb_auto_part_2() {
    return array(
        'post' => array(
            'post_title' => 'WPB Auto Part V2',
            'post_name' => 'wpb-auto-part-v2',
            'post_content' => '[vc_row el_class="margin-bottom-20 nasa-crazy-box" css=".vc_custom_1634028816822{background-image: url(https://via.placeholder.com/1920x700) !important;background-position: center !important;background-repeat: no-repeat !important;background-size: cover !important;}"][vc_column parallax="content-moving" el_class="desktop-padding-top-100 desktop-padding-bottom-150 mobile-padding-top-50 mobile-padding-bottom-50 desktop-padding-left-100 desktop-padding-right-100"][vc_column_text]
...
[/vc_column_text][nasa_product_nasa_categories count_items="1"][/vc_column][/vc_row][vc_row el_class="margin-bottom-30"][vc_column][nasa_brands images="3074,3074,3074,3074,3074,3074" columns_number="6" columns_number_tablet="4" columns_number_small="3" custom_links="#,#,#,#,#,#"][/vc_column][/vc_row][vc_row el_class="margin-bottom-20"][vc_column width="1/2"][nasa_banner valign="middle" hover="zoom" img_src="3117"]
...
<a class="button margin-top-30" style="font-size: 12px; border-radius: 5px;" title="Shop now" href="#">Shop Now</a>[/nasa_banner][/vc_column][vc_column width="1/2"][nasa_banner valign="middle" hover="zoom" img_src="3117"]
<h4>Auto Repair</h4>
...
<a class="button margin-top-20" style="border-radius: 5px;" title="Shop now" href="#">Start Buying</a>[/nasa_banner][/vc_column][/vc_row][vc_row parallax="content-moving" el_class="margin-bottom-30"][vc_column][nasa_products_special_deal limit="6" style="multi-2" arrows="1" auto_slide="false" category_product="auto-accessories-bags" el_class="hide-stars"][/vc_column][/vc_row][vc_row el_class="margin-bottom-30 mobile-margin-bottom-20"][vc_column width="1/3" el_class="mobile-margin-top-20"][nasa_title title_text="Featured" title_type="h3" font_size="m" el_class="margin-bottom-30"][nasa_products type="featured_product" style="list_carousel" style_row="3" pos_nav="left" arrows="1" number="6" columns_number="1" columns_number_tablet="1" columns_number_small="1"][/vc_column][vc_column width="1/3" el_class="mobile-margin-top-30"][nasa_title title_text="Best Selling" title_type="h3" font_size="m" el_class="margin-bottom-30"][nasa_products type="best_selling" style="list_carousel" style_row="3" pos_nav="left" arrows="1" number="6" columns_number="1" columns_number_tablet="1" columns_number_small="1"][/vc_column][vc_column width="1/3" el_class="mobile-margin-top-30"][nasa_title title_text="On Sale" title_type="h3" font_size="m" el_class="margin-bottom-30"][nasa_products type="on_sale" style="list_carousel" style_row="3" pos_nav="left" arrows="1" number="6" columns_number="1" columns_number_tablet="1" columns_number_small="1"][/vc_column][/vc_row][vc_row el_class="margin-bottom-50 mobile-margin-bottom-0"][vc_column width="1/4" offset="vc_col-xs-12" el_class="mobile-margin-bottom-30"][nasa_service_box service_hover="buzz_effect" service_title="Free Delivery" service_desc="Free Shipping for all Order" service_icon="icon-nasa-car-2"][/vc_column][vc_column width="1/4" offset="vc_col-xs-12" el_class="mobile-margin-bottom-30"][nasa_service_box service_hover="buzz_effect" service_title="Support 24/7" service_desc="We support 24h a day" service_icon="icon-nasa-headphone"][/vc_column][vc_column width="1/4" offset="vc_col-xs-12" el_class="mobile-margin-bottom-30"][nasa_service_box service_hover="buzz_effect" service_title="100% Money Back" service_desc="You have 30 days to Return" service_icon="icon-nasa-refresh"][/vc_column][vc_column width="1/4" offset="vc_col-xs-12" el_class="mobile-margin-bottom-30"][nasa_service_box service_hover="buzz_effect" service_title="Payment Secure" service_desc="We ensure secure payment" service_icon="icon-nasa-credit"][/vc_column][/vc_row]'
        ...
        'post_meta' => array(
            ...
            '_wpb_shortcodes_custom_css' => '.vc_custom_1634028816822{background-image: url(https://via.placeholder.com/1920x700) !important;background-position: center !important;background-repeat: no-repeat !important;background-size: cover !important;}'
        )
    );
}
