<?php
function nasa_wpb_organic() {
    return array(
        'post' => array(
            'post_title' => 'WPB Organic',
            'post_name' => 'wpb-organic',
    ...
    [/nasa_banner][/vc_column][vc_column width="1/3"][nasa_banner effect_text="fadeInLeft" hover="zoom" img_src="3136"]
    ...
    Vegetables</h3>
    <h5 style="font-size: 100%; line-height: 5;"><a title="Shop Now" href="#">Shop Now</a></h5>
    [/nasa_banner][/vc_column][/vc_row][vc_row el_class="margin-top-50"][vc_column width="1/3"][nasa_title title_text="Top Rate" title_type="h3" font_size="m" el_class="margin-bottom-30"][nasa_products type="top_rate" style="list_carousel" style_row="3" arrows="1" number="6" columns_number="1" columns_number_small="1" columns_number_tablet="1"][/vc_column][vc_column width="1/3"][nasa_title title_text="Best Selling" title_type="h3" font_size="m" el_class="margin-bottom-30"][nasa_products type="best_selling" style="list_carousel" style_row="3" arrows="1" number="6" columns_number="1" columns_number_small="1" columns_number_tablet="1"][/vc_column][vc_column width="1/3"][nasa_title title_text="On Sales" title_type="h3" font_size="m" el_class="margin-bottom-30"][nasa_products type="on_sale" style="list_carousel" style_row="3" arrows="1" number="6" columns_number="1" columns_number_small="1" columns_number_tablet="1"][/vc_column][/vc_row][vc_row el_class="padding-top-20 margin-bottom-50"][vc_column][nasa_brands images="3074,3074,3074,3074,3074,3074" columns_number="6" columns_number_tablet="4" columns_number_small="3" custom_links="#,#,#,#,#,#"][/vc_column][/vc_row]'
        ),
        'post_meta' => array(
