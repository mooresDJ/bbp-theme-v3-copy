...
<a class="button small fs-16 hide-for-small" style="background-color: #fed65a; text-transform: capitalize; color: #000; letter-spacing: 0;" title="Shop now" href="#">Shop Now</a>[/nasa_banner_2][nasa_banner_2 effect_text="fadeInLeft" img_src="3556"]
<h3 class="desktop-margin-top-18 fs-20 mobile-fs-15 desktop-margin-bottom-15" style="color: #fff; font-weight: 300 !important;">Best choise</h3>
...
<a class="button small fs-16 hide-for-small" style="background-color: #fed65a; text-transform: capitalize; color: #000; letter-spacing: 0;" title="Shop now" href="#">Shop Now</a>[/nasa_banner_2][/nasa_slider][/vc_column][vc_column width="1/3" el_class="rtl-left"][nasa_banner_2 effect_text="flipInX" hover="zoom" img_src="3555"]
...
[/nasa_banner_2][nasa_banner_2 valign="middle" effect_text="flipInX" hover="zoom" img_src="3555"]
...
&amp; Relaxation</h3>
<a class="primary-color button small fs-13 tablet-fs-11" style="text-transform: capitalize; letter-spacing: 0;" title="Shop now" href="#">Shop Now</a>[/nasa_banner_2][/vc_column][vc_column width="1/3" offset="vc_col-md-4"][nasa_banner_2 effect_text="flipInX" data_delay="600ms" hover="zoom" img_src="3318"]
...
[/nasa_banner_2][/vc_column][vc_column width="1/3" offset="vc_col-md-4"][nasa_banner_2 valign="middle" effect_text="fadeInUp" data_delay="600ms" hover="zoom" img_src="3318"]
...
Temperature Gun</h4>
<a class="primary-color button small fs-13 tablet-fs-11" style="text-transform: capitalize; letter-spacing: 0;" title="Shop now" href="#">Shop Now</a>[/nasa_banner_2][/vc_column][/vc_row][vc_row el_class="margin-bottom-60 tablet-margin-bottom-40 mobile-margin-bottom-20"][vc_column][nasa_products_special_deal limit="5" style="multi-2" arrows="1" auto_slide="false" el_class="nasa-demo"][/vc_column][/vc_row][vc_row el_class="margin-bottom-40 tablet-margin-bottom-30 mobile-margin-bottom-30"][vc_column width="1/3"][nasa_title title_text="Top Rated" font_size="m" el_class="margin-bottom-30"][nasa_products type="featured_product" style="list_carousel" style_row="3" arrows="1" number="6" columns_number="1" columns_number_tablet="1" columns_number_small="1"][/vc_column][vc_column width="1/3" el_class="mobile-margin-bottom-10"][nasa_title title_text="Best Selling" font_size="m" el_class="margin-bottom-30"][nasa_products type="best_selling" style="list_carousel" style_row="3" arrows="1" number="6" columns_number="1" columns_number_tablet="1" columns_number_small="1"][/vc_column][vc_column width="1/3"][nasa_title title_text="On Sale" font_size="m" el_class="margin-bottom-30"][nasa_products type="on_sale" style="list_carousel" style_row="3" arrows="1" number="6" columns_number="1" columns_number_tablet="1" columns_number_small="1"][/vc_column][/vc_row][vc_row el_class="margin-bottom-30 tablet-margin-bottom-50 mobile-margin-bottom-0"][vc_column][nasa_title title_text="Advice From Health Experts" title_desc="The freshest and most exciting news" font_size="m" el_class="margin-bottom-30"][nasa_post dots="true" arrows="1" posts="5" columns_number="4" columns_number_small_slider="1" columns_number_tablet="2" readmore="no" page_blogs="no"][/vc_column][/vc_row]'
        ),
        'post_meta' => array(
