<?php
function nasa_wpb_auto_part_1() {
    return array(
        'post' => array(
            'post_title' => 'WPB Auto Part V1',
            'post_name' => 'wpb-auto-part-v1',
            'post_content' => '[vc_row fullwidth="1" el_class="margin-bottom-20"][vc_column][nasa_rev_slider alias="slider-auto-part-v1" alias_m="slider-auto-part-v1"][/vc_column][/vc_row][vc_row el_class="margin-bottom-30 mobile-margin-bottom-50"][vc_column width="1/2"][nasa_banner valign="middle" hover="zoom" img_src="3117"]
...
<a class="button margin-top-30" style="border-radius: 5px; letter-spacing: 1.5px;" title="Shop now" href="#">Shop Now</a>[/nasa_banner][/vc_column][vc_column width="1/2"][nasa_banner valign="middle" hover="zoom" img_src="3117"]
<h4>Auto Repair</h4>
