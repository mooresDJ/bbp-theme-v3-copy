...
function nasa_wpb_watch() {
    return array(
        'post' => array(
            ...
            'post_name' => 'wpb-watch',
            'post_content' => '[vc_row fullwidth="1" el_class="margin-bottom-30"][vc_column][nasa_rev_slider alias="slider-watch-light"][/vc_column][/vc_row][vc_row][vc_column width="1/2"][nasa_banner align="center" valign="middle" text-align="text-center" hover="zoom" img_src="3117"]
...
[/nasa_banner][/vc_column][vc_column width="1/2"][nasa_banner valign="middle" hover="zoom" img_src="3117"]
