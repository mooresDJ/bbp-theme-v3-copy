...
function nasa_wpb_jewelry() {
    return array(
        'post' => array(
            ...
            'post_content' => '[vc_row fullwidth="1"][vc_column][nasa_rev_slider alias="slider-jewelry"][/vc_column][/vc_row][vc_row el_class="margin-bottom-50 margin-top-20"][vc_column width="1/2"][nasa_banner banner_responsive="no" effect_text="fadeInLeft" hover="zoom" img_src="3094"]
