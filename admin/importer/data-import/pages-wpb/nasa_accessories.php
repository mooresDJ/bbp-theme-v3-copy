...
function nasa_wpb_accessories() {
    ...
    [/vc_column_text][nasa_product_nasa_categories hide_empty="0"][/vc_column][/vc_row][vc_row el_class="margin-bottom-20"][vc_column width="1/3"][nasa_banner valign="middle" effect_text="fadeInLeft" hover="zoom" img_src="3136"]
    ...
    <a class="button margin-top-15" href="#">Shop Now</a>[/nasa_banner][/vc_column][vc_column width="1/3"][nasa_banner hover="zoom" img_src="3136"][/nasa_banner][/vc_column][vc_column width="1/3"][nasa_banner valign="middle" effect_text="fadeInLeft" hover="zoom" img_src="3136"]
    ...
    [/nasa_banner][nasa_banner move_x="10%" valign="middle" banner_responsive="no" img_src="3197"]
    <h6 class="margin-top-0 desktop-margin-bottom-10 mobile-margin-bottom-5">MOBILE ACCESSORIES</h6>
    ...
    [nasa_countdown date="2023-12-31" size="small" align="left" el_class="rtl-text-right"]
    <div class="margin-top-20"><a class="button small" title="Shop now" href="#">Shop Now</a></div>
    [/nasa_banner][/nasa_slider][/vc_column][/vc_row][vc_row el_class="margin-bottom-30"][vc_column width="1/3"][nasa_title title_text="Top Rate" title_type="h3" font_size="m" el_class="margin-bottom-30"][nasa_products style="list_carousel" style_row="3" arrows="1" number="6" columns_number="1" columns_number_small="1" columns_number_tablet="1"][/vc_column][vc_column width="1/3"][nasa_title title_text="Best Selling" title_type="h3" font_size="m" el_class="margin-bottom-30"][nasa_products style="list_carousel" style_row="3" arrows="1" number="6" columns_number="1" columns_number_small="1" columns_number_tablet="1"][/vc_column][vc_column width="1/3"][nasa_title title_text="On Sale" title_type="h3" font_size="m" el_class="margin-bottom-30"][nasa_products style="list_carousel" style_row="3" arrows="1" number="6" columns_number="1" columns_number_small="1" columns_number_tablet="1"][/vc_column][/vc_row][vc_row][vc_column][nasa_title title_text="Lastest news" title_desc="Featured pharecha est nec ligula efficitur" title_type="h3" font_size="l" title_align="text-center" el_class="margin-bottom-30"][nasa_post arrows="0" posts="4" columns_number="3" columns_number_small="1" columns_number_tablet="2" readmore="no"][/vc_column][/vc_row][vc_row el_class="margin-bottom-10"][vc_column][nasa_products_viewed title="Recently Viewed" columns_number="4" columns_number_small="1" columns_number_tablet="3" el_class="nasa-hide-stars"][/vc_column][/vc_row][vc_row el_class="margin-bottom-40"][vc_column][nasa_brands images="3074,3074,3074,3074,3074,3074" columns_number="6" columns_number_tablet="4" columns_number_small="3"][/vc_column][/vc_row]'
        ),
        'post_meta' => array(
