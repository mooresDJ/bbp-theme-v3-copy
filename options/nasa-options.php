...
function elessi_enqueue_style() {
     ...
     * MAIN CSS
     */
    wp_enqueue_style( 'site-css', get_stylesheet_directory_uri() . '/css/app.css', array(), filemtime(get_stylesheet_directory() . '/css'), 'all' );
    ...
    if (NASA_ELEMENTOR_ACTIVE) {
        ...
        if ((isset($_REQUEST['elementor-preview']) && $_REQUEST['elementor-preview']) || (isset($_REQUEST['preview_id']) && $_REQUEST['preview_id'])) {
            ...
            wp_enqueue_style('elessi-style-elementor-preview', ELESSI_THEME_URI . '/assets/css/style-elementor-preview.css', array(), $themeVersion);
        }
    }
...
function elessi_enqueue_scripts() {
    ...
    if (NASA_WOO_ACTIVED) {
        ...
        if (
            ...
            wp_enqueue_script('elessi-sp-multi-currencies', ELESSI_THEME_URI . '/assets/js/min/sp-multi-currencies.min.js', array('jquery'), $themeVersion, true);
        }
    }
